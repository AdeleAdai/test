...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-zinc-950">
      ...
      <main className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <WelcomeHero />
      </main>

      <footer className="absolute bottom-8 left-0 w-full text-center text-zinc-500 text-sm tracking-widest uppercase">
